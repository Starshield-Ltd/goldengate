...
const AISearch = () => {
  const tools = [
    ...
    { id: 'omniplex', name: 'Omniplex AI', url: '/ai-search/omniplex', description: 'Access the full Omniplex AI platform to enhance your research and learning.' },
    { id: 'andisearch', name: 'Andi Search', url: '/ai-search/andi-search', description: 'Access the full Andi Search platform to enhance your research and learning.' },
  ];
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 pt-24 pb-12">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <h1 className="text-3xl font-bold mb-8 text-center">AI Search Tools</h1>
